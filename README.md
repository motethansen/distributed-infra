...
|---|---|---|---|
| `michaels-macbook-pro` | REDACTED-ORCHESTRATOR-IP | **Orchestrator** | Main dev, queue server, CLI |
| `michaelhansen-thinkpad-x13-gen-4` | REDACTED-THINKPAD-IP | **Worker** | Android builds, backend dev |
| `mac-mini` | REDACTED-MACMINI-IP | **Worker** | iOS / Xcode builds |
